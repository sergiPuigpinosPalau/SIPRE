...
class ProductSpecificationTest {
    ...
    @Test
    @DisplayName("Check that the product specification gets created without any errors")
    void createProductSpecification() throws InvalidPriceFormat, StringTooLongException, InvalidUPCFormat {
        ...
        assertThrows(IllegalArgumentException.class, () -> produc = new ProductSpecification(null, descripcionOK, null));
        assertThrows(IllegalArgumentException.class, () -> produc = new ProductSpecification(new ProductID("123456789123"), null, priceOK));
        assertThrows(StringTooLongException.class, () -> produc = new ProductSpecification(new ProductID("123456789123"), descripcionNoValid, priceOK));
        assertThrows(InvalidPriceFormat.class, () -> produc = new ProductSpecification(new ProductID("123456789123"), descripcionOK, priceNoValid1));
        assertThrows(InvalidPriceFormat.class, () -> produc = new ProductSpecification(new ProductID("123456789123"), descripcionOK, priceNoValid2));
        assertThrows(InvalidPriceFormat.class, () -> produc = new ProductSpecification(new ProductID("123456789123"), descripcionOK, priceNoValid3));
    }
    ...
    void testSetters() throws InvalidUPCFormat, InvalidPriceFormat, StringTooLongException {
        produc = new ProductSpecification(new ProductID("123456789123"), descripcionOK, priceOK);
        assertThrows(IllegalArgumentException.class, () -> produc.setUPCcode(null));
        assertThrows(IllegalArgumentException.class, () -> produc.setDescription(null));
        assertThrows(IllegalArgumentException.class, () -> produc.setPrice(null));
    }

    @Test
    @DisplayName("Check equals")
    void equalsTest() throws InvalidUPCFormat, InvalidPriceFormat, StringTooLongException {
